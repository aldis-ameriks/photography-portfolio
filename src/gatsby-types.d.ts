...
type ProjectNodesQuery = { readonly projects: { readonly edges: ReadonlyArray<{ readonly node: { readonly fileAbsolutePath: string, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string } | null } }> } };

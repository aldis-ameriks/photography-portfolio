...
type MdxFrontmatter = {
  readonly areas: Maybe<ReadonlyArray<Maybe<Scalars['String']>>>;
...
type MdxFrontmatterFieldSelector = {
  readonly areas: InputMaybe<FieldSelectorEnum>;
...
type MdxFrontmatterFilterInput = {
  readonly areas: InputMaybe<StringQueryOperatorInput>;
...
type MdxFrontmatterSortInput = {
  readonly areas: InputMaybe<SortOrderEnum>;
...
type HomeQuery = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: { readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly date: string | null, readonly title: string | null, readonly areas: ReadonlyArray<string | null> | null, readonly cover: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } }> }, readonly allFile: { readonly nodes: ReadonlyArray<{ readonly birthTime: string, readonly childImageSharp: { readonly fluid: import('gatsby-plugin-image').IGatsbyImageData, readonly fixed: import('gatsby-plugin-image').IGatsbyImageData } | null }> } };
...
type ProjectNodesQuery = { readonly projects: { readonly edges: ReadonlyArray<{ readonly node: { readonly internal: { readonly contentFilePath: string | null }, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null } | null } }> } };
